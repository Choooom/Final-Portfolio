...
const Projects: React.FC<ProjectsSectionProps> = ({
  ...
  const projects: Project[] = [
    {
      number: "01",
      title: "FA Simon Landing Page",
      category: "Landing Page",
      year: "2026",
      image: "./img/all/FA_Simon_LandingPage.png",
      imageDetail: "./img/all/FA_description.png",
      description:
        "FA Simon is a responsive landing page and client engagement platform built for financial advisors. It streamlines appointment scheduling, policy presentation, and client inquiries through an integrated booking system and custom insurance policy sample feature, helping simplify consultations and improve client interaction workflows.",
      color: "77, 128, 237",
      technologies: {
        frontend: "React, NextJS, TailwindCSS",
        backend: "Supabase, PostgreSQL",
      },
      link: "https://github.com/Choooom",
    },
    {
      number: "02",
      title: "Expenso",
      ...
      year: "2026",
      image: "./img/all/Expenso-1.png",
      imageDetail: "./img/all/Expenso-2.png",
      description:
        "Expenso is a personal expense tracking web application designed to help users easily monitor and manage their daily spending. It features a voice AI input system that allows users to simply speak the items they purchased instead of manually typing them, making expense logging faster and more convenient. This approach helps users stay consistent with budgeting and gain better control over their financial habits.",
      technologies: {
        frontend: "HTML, CSS, JavaScript",
        backend: "Supabase",
      },
      color: "0 122 255",
      link: "https://github.com/cndrz/Expenso",
    },
    {
      number: "03",
      title: "EWATTS",
      ...
      year: "2025-2026",
      image: "./img/all/EWATTS.jpg",
      imageDetail: "./img/all/EWATTS-2.jpg",
      description: `EWATTS is an AI-powered portfolio and solar energy management platform designed to optimize household energy consumption through predictive analytics. The system uses Long Short-Term Memory (LSTM) for forecasting electricity usage and Random Forest algorithms for weather prediction, helping users efficiently manage solar-generated energy and reduce energy waste.`,
      technologies: {
        frontend: "Flutter",
        backend: "Spring, MySQL, Cloudflare",
      },
      color: "121 35 208",
      link: "https://github.com/Choooom/EWatts_Mobile",
    },
    {
      number: "04",
      title: "Rescreen",
      ...
      year: "2021-Now",
      image: "./img/all/Rescreen.png",
      imageDetail: "./img/all/Rescreen-2.png",
      description: `Rescreen is a modern portfolio and resume-building platform designed to help users create professional digital profiles and showcase their skills, projects, and experiences online. The website provides an organized and user-friendly interface for presenting personal achievements, making it easier for professionals and students to build their online presence and share their portfolios with employers or clients.`,
      technologies: {
